...
fn parse_group(
    ...
    match group.delimiter() {
        ...
        delimiter => {
            let mut new_sequence = match delimiter {
                Delimiter::Parenthesis => RicciSequence::with_parens(group.span()),
                Delimiter::Brace => RicciSequence::with_braces(group.span()),
                _ => RicciSequence::naked(group.span()),
            };
            parse_sequence(
